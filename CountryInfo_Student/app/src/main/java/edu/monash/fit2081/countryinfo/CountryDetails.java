...
public class CountryDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wikiBtn = findViewById(R.id.wiki_button);
    ...
    private class GetCountryDetails extends AsyncTask<String, String, CountryInfo> {
        ...
        protected void onPostExecute(final CountryInfo countryInfo) {
            ...
            wikiBtn.setText("WIKI " + countryInfo.getName().toUpperCase());
            String flagUrl = String.format("https://www.countryflags.io/%s/flat/64.png",countryInfo.getAlpha2Code());
            ...
            wikiBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("country name", countryInfo.name);
    ...
    public class GetFlag extends AsyncTask<String, String, Bitmap> {
        @Override
        protected Bitmap doInBackground(String... strings) {
            ...
            try {
                ...
                flagImg = BitmapFactory.decodeStream(input);
            } catch (Exception e) {
                Log.i("INFO", "Error " + e.toString());
            }
            return flagImg;
